...
/**
 * Launches the system consent dialog from `MediaStore.createWriteRequest` for
 * files this app doesn't own. Mirrors expo-media-library's own WriteContract
 * (used there for the same purpose ahead of deletes) — same mechanism, just
 * for a rename instead.
 */
class WriteContract(
